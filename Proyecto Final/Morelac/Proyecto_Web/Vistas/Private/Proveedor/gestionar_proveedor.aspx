<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Private/Home/Admin.Master" AutoEventWireup="true" CodeBehind="gestionar_proveedor.aspx.cs" Inherits="Proyecto_Web.Vistas.Private.gestionar_proveedor" %>
                    ...
                    <div class="col-md-10">
                        <div class="contact-form">
                            <div class="card-header">
                                <br />
                                <h4 class="card-title">MODIFICAR PROVEEDOR</h4>
                            </div>
                            <div>
                                <div class="row">
                                    <div class="col-md-3">
