<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Private/Home/Admin.Master" AutoEventWireup="true" CodeBehind="Perfil.aspx.cs" Inherits="Proyecto_Web.Vistas.Private.Perfil" %>
    ...
    <header class="header black-bg">
      ...
      <div class="nav notify-row" id="top_menu">
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar" class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="../Public/Index.aspx">
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="../Public/login.aspx">Cerrar Sesión</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
          ...
          <h5 class="centered">Sam Soffes</h5>
           <li>
            ...
            <li class="sub-menu dcjq-parent-li">
                ...
                <ul class="sub">
                    <li><a href="gestionar_supervisor.aspx">SUPERVISOR</a></li>
                    <li><a href="gestionar_proveedor.aspx">PROVEEDOR</a></li>
                    <li><a href="gestionar_cliente.aspx">CLIENTE</a></li>
                </ul>
            </li>
            <li class="sub-menu dcjq-parent-li">
                <a href="javascript:;" class="dcjq-parent">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li><a href="abono_clientes.aspx">ABONO CLIENTES</a></li>
                    <li><a href="abono_proveedores.aspx">ABONO PROVEEDORES</a></li>
