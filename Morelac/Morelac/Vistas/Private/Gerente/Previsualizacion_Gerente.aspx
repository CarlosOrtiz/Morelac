<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Private/Home/Admin.Master" AutoEventWireup="true" CodeBehind="Previsualizacion_Gerente.aspx.cs" Inherits="Proyecto_Web.Vistas.Private.Gerente.Previsualizacion_Gerente" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <section class="content-header height-title">
        <h3 class="margin-top-5"><i class="fa fa-folder-open"></i>&nbsp Información de Gerente</h3>
    </section>
    <section class="content">
        <div class="row box box-primary no-margin">
            ...
            <div class="box-footer text-right">
                <a href="Modificar_Gerente.aspx?Valor=<%=Convert.ToString(Request.QueryString["Valor"])%>" class="btn btn-primary"><i class="fa fa-pencil"></i>&nbsp Modificar</a>
            </div>
            </div>
    </section>
