                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 box-header with-border" style="text-align: center;">
                                <asp:LinkButton Style="margin-bottom: 5px;" ID="Btn_Save1" runat="server" CssClass="btn btn-success" OnClick="Btn_Save1_Click"><i class="fa fa-save"></i>&nbsp Guardar Datos</asp:LinkButton>
            ...
            <div class="col-md-9">
                        ...
                        <div class="active tab-pane" id="Modificar">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:TextBox ID="Celular" runat="server" data-inputmask="&quot;mask&quot;: &quot;(999) 999-9999&quot;" data-mask="" required TextMode="Number" onKeyPress="return soloNumeros(event)" autocomplete="off" onkeyDown="checkTextAreaMaxLength(this,event,'10');" placeholder="3144865298" oncopy="return false" onpaste="return false" oncut="return false" CssClass="form-control style-form "></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:DropDownList ID="DDL_Sexo" CssClass="form-control select2" required runat="server" BackColor="White">
                        ...
                        <div class="tab-pane" id="Modificar2">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:TextBox runat="server" ID="ape2" CssClass="form-control style-form solo-letras" placeholder="JUAN" MaxLength="10" onkeyDown="checkTextAreaMaxLength(this,event,'10');" pattern="[A-Za-z]+"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:TextBox ID="Direc" runat="server" aria-describedby="addon-right addon-left" placeholder="CAQUETA-FLORENCIA-ATALAYA" MaxLength="40" onkeyDown="checkTextAreaMaxLength(this,event,'40');" CssClass="form-control style-form solo-letras" pattern="[A-Za-z]+"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <span class="help-block">Contador de caracteres</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="Act_Logo">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:TextBox runat="server" MaxLength="45" ID="nom_finca" CssClass="form-control style-form solo-letras" placeholder="LA GLORIA" autocomplete="off" onkeyDown="checkTextAreaMaxLength(this,event,'45');" oncopy="return false" onpaste="return false" oncut="return false" pattern="[A-Za-z]+"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">UBICACIÓN DE SU FINCA</label>
                                    <div class="col-sm-9">
                                        <asp:TextBox runat="server" MaxLength="45" ID="ubi_finca" CssClass="form-control style-form solo-letras" placeholder="LA MONTAÑITA" autocomplete="off" onkeyDown="checkTextAreaMaxLength(this,event,'45');" oncopy="return false" onpaste="return false" oncut="return false" pattern="[A-Za-z]+"></asp:TextBox>
                                    </div>
                                </div>
                ...
                <span class="input-group-addon">.00</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:TextBox runat="server" ID="hectarias" onKeyPress="return soloNumeros(event)" onkeyDown="checkTextAreaMaxLength(this,event,'45');" MaxLength="45" CssClass="form-control  col-sm-6" placeholder=""></asp:TextBox>
                                         <span class="input-group-addon col-sm-2">.00</span>
                                    </div>
                                </div>
                                <div class="form-group">
